  ...
  <div class="left_menu">
    ...
    <div class="m-right">
      ...
      <div class="main">
        ...
        <form class="f1" action="Tsingle_sumbit.jsp?course=<%="math" %>" method="post" > 
<fieldset > 
...
<tr><td class="left"><label for="D">Answer</label></td>
<td class="right"><input type="radio"  name="answer" value="A" checked />A<!-- name设置成一样的就行了--> 
