...
allstudents=r.potoid("math", 1);
int num=allstudents.size();
%>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Checking examination papers</title>
...
<div id="content">
  <div class="left_menu">
        ...
        <li>
          <h4 class="M4"><span></span>Give points<mark><%=num %></mark></h4>
          <div class="list-item none">
    ...
    <div class="m-right">
      ...
      <div class="main">
        ...
        <tr>
        <tr>
        <th>Examination Total Score</th><td>100</td>
        <tr>
        </table>

      
        <table id="alltable" class="tablesorter">
        <caption>Checking examination papers</caption>
        <thead> 
        <tr>
        <th>Students</th><th>Name</th><th>Grade</th>
        </tr>
        </thead>
        <tbody> 
         <% 
          ...
          %>
          <tr>
          <td><%=allstudents.get(i)%></td><%=i%><td><%d.getstuinfo(allstudents.get(i)); %><%=d.getName() %></td><td><a href="Tmark.jsp?course=<%=course%>&sid=<%=allstudents.get(i)%>">Check</a></td>
          </tr>
          <%
          }
          %>   
