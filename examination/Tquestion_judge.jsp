  ...
  <div class="left_menu">
    ...
    <div class="m-right">
      ...
      <div class="main">
        ...
        <form class="f1" action=Tjudge_sumbit.jsp?course=<%="XML" %> method="post" > 
<fieldset > 
...
<td> <input type="file" id="f1" name="imgquestion" value="File1" accept=".png,.gif,.jpg,.jpeg"/></td> 
</tr>
<tr><td class=“left” width=40% align="center" rowspan=2 height=25%> 
<input id="Submit1" type="submit" value="submit" /> 
</td> 
<td class="right" height=38%> <input id="Reset1" type="reset" value="reset" /> 
</td> 
</tr> 
</tbody> 
</table> 
