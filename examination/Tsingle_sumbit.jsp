...
System.out.println(answer);//receive the score

System.out.println(value);
xml_reader r=new xml_reader();
int allnum=r.getAllNumber(course, "c");
...
<%
xml_writer.CreateChooseXMLFile(r.getPath(course,"c"), "s");
%>
<head>
  ...
  <div class="left_menu">
    ...
    <div class="m-right">
      ...
      <div class="main">
        ...
        Submit the single selective question Successfully!!!
