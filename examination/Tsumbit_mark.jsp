...
{
	String id=qid.get(i);
	score.add(request.getParameter(id));//存储学生的成绩
	out.println("hello"+score.get(i));
	total = total + Integer.valueOf(score.get(i));
}
xml_modify m=new xml_modify();
m.setSubjectPoints(total);


m.setPstate("2");
int obj = r.getObjectPoints(course, sid);
System.out.println("ok");
System.out.println(obj);
int all = total + obj;
m.setSubjectPoints(all);
db_modify d = new db_modify();
d.modifyGrades(course, sid, all);
//change the paper state
...
<div id="content">
  <div class="left_menu">
        ...
        <li>
          ...
          <div class="list-item none">
          <a href="ttotal.jsp?course=<%=course %>">Total</a>
          </div>
        </li>
        <li>
    ...
    <div class="m-right">
      ...
      <div class="main">
        ...
        Submit the student marking Successfully!!!
